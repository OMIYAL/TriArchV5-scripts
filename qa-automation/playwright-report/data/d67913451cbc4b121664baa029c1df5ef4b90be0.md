...
- Name: tests\theme.spec.ts >> Theme Settings >> should switch to Dark theme
- Location: tests\theme.spec.ts:111:7
...
Call log:
  - waiting for locator('#settings-routes .lpx-menu-item-link').filter({ hasText: /^Dark$/ }) to be visible
