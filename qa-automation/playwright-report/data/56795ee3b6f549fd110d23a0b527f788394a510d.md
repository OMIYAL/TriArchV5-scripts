...
- Name: tests\theme.spec.ts >> Theme Settings >> should switch to System theme
- Location: tests\theme.spec.ts:115:7
...
Call log:
  - waiting for locator('#settings-routes .lpx-menu-item-link').filter({ hasText: /^System$/ }) to be visible
