...
- Name: tests\theme.spec.ts >> Theme Settings >> should switch to Semi-Dark theme
- Location: tests\theme.spec.ts:107:7
...
Call log:
  - waiting for locator('#settings-routes .lpx-menu-item-link').filter({ hasText: /^Semi-Dark$/ }) to be visible
